...
<p align="left"> В данный момент в моем профиле либо нет проектов, либо они с приватным доступом, так как я работаю над бизнес задачами которые я не могу публиковать по понятным причинам. Но в скором времени я планирую добавить пару интересных наработок с открытым исходным кодом</p>
